...
from ....models import AppUser, Project, Task
...
class ProjectsController:
    ...
    def get_project(project_id):
        try:
            ...
            api_response = success_response("Project fetched successfully", 200, extra_data)
        except Exception as e:
            log_exception("An exception occurred adding a project:", e)
            api_response = error_response("An unexpected error occurred", 500)
        finally:
    ...
    def delete_project(project_id):
        try:
            ...
            tasks: list[Task] = Task.query.filter_by(project_id=project_id).all()
            
            [task.delete() for task in tasks]
            project.delete()
            
            api_response = success_response("Project deleted successfully", 200)
        except Exception as e:
            log_exception("An exception occurred adding a project:", e)
            api_response = error_response("An unexpected error occurred", 500)
        finally:
